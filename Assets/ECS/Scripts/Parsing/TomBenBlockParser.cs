...
namespace wave_spawning
{
    ...
    public class TomBenBlockParser
    {
        ...
        private void HandleOutsideBlockState(char c)
        {
        ...
        private ParsedBlockType GetBlockTypeFromString(string type) => type switch
        {
        ...
        public WaveAuthoring ParseWaveBlock(in ParsedBlock block, in ParsedBlockHeader header)
        {
            ...
            //Assert fires an error if the condition is false
            ...
            foreach (char c in fileContent)
            {
                ...
                switch (m_State)
                {
                    ...
                    case BlockParserState.InsideBody:
                        ...
                        if (canAddBlock)
                        {
                            //Add the finished block to the total list, ready for output.
